      ...
      {aircrafts.map((aircraft, idx) => (
        <div key={idx} className="aircraft-card">
          ...
          <div className="aircraft-details">
            <p>
              <strong>Range:</strong> {aircraft.range}
            </p>
            <p>
              <strong>Seats:</strong> {aircraft.seats}
            </p>
            <p>
              <strong>Min Runway:</strong> {aircraft.runway}
            </p>
            <p>
              <strong>Available:</strong> {aircraft.available}
            </p>
            <p>
              <strong>Lease:</strong> {aircraft.lease}
            </p>
          </div>
            ...
            <form onSubmit={handleBookingSubmit}>
              ...
              <div className="cost-summary">
                ...
                <p>
                  ...
                  {(
                    parseInt(selectedAircraft.lease.replace(/\D/g, "")) / 30
                  ).toFixed(2)}
                </p>
                <p>
                  <strong>Total for {days} day(s):</strong> $
                  {calculateTotalCost(selectedAircraft.lease)}
                </p>
              </div>
